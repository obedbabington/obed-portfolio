    ...
    <Column maxWidth="m" gap="xl" paddingY="12" horizontal="center" className="mobile-padding fixed-header-spacing ai-gradient" style={{ animation: "fadeIn 1s ease-out" }}>
      ...
      <Column fillWidth horizontal="center" gap="m">
        <Column maxWidth="s" horizontal="center" align="center" style={{ position: "relative", marginTop: "-16px" }}>
          ...
          <Heading wrap="balance" variant="display-strong-l" style={{ fontWeight: 800, animation: "fadeIn 1s ease-out", lineHeight: "1.2" }}>
            {home.headline}
          </Heading>
          <Text wrap="balance" onBackground="neutral-weak" variant="heading-default-xl" style={{ fontWeight: 500, animation: "fadeIn 1s ease-out 0.3s both", marginTop: "32px", lineHeight: "1.4" }}>
            {home.subline}
          </Text>
